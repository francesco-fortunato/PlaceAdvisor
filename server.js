...
app.get('/log',function (req,res){
  res.redirect("https://www.facebook.com/v18.0/dialog/oauth?client_id="+process.env.CLIENT_ID+"&redirect_uri=http://localhost:8000/homepage&response_type=code&scopes=user_birthday&user_hometown&user_gender");
});
